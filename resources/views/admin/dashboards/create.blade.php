...
@section('content')
    <div class="row">
        <div class="col-sm-4">
            <form method="post" action="/admin/dashboards/create" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="display_time" id="display_time" placeholder="Enter display time">
                </div>
                <div class="form-group">
                    <label for="logo">Dashboard logo</label><br>
                    <img src="" id="preview" alt="Logo preview" class="img-thumbnail" style="height:90px;">
                ...
                <button class="btn btn-success" type="submit">Save dashboard</button>
            </form>
        </div>
    </div>
@stop
